...
{
	boost::assign::insert(cmd_map)("is_admin", cmd_is_admin)("is_authd", cmd_is_authd)("is_device", cmd_is_device)("is_gateway", cmd_is_gateway)("get_my_device_id", cmd_get_my_device_id)("get_data_receiver", cmd_get_data_receiver)("get_default_data_receiver", cmd_get_default_data_receiver)("get_key", cmd_get_key)("get_addr_type", cmd_get_addr_type)("get_addr", cmd_get_addr)("get_name", cmd_get_name)("get_mac", cmd_get_mac)("get_data", cmd_get_data)("get_data_timestamp", cmd_get_data_timestamp)("get_creation_timestamp", cmd_get_creation_timestamp)("get_num_admin", cmd_get_num_admin)("get_num_devices", cmd_get_num_devices)("get_num_gateways", cmd_get_num_gateways)("get_active_admins", cmd_get_active_admins)("get_authorized_devices", cmd_get_authorized_devices)("get_authorized_gateways", cmd_get_authorized_gateways)("add_device", cmd_add_device)("add_gateway", cmd_add_gateway)("remove_device", cmd_remove_device)("remove_gateway", cmd_remove_gateway)("update_data_receiver", cmd_update_data_receiver)("set_default_data_receiver", cmd_set_default_data_receiver)("update_addr", cmd_update_addr)
		// ("push_data",                 cmd_push_data)
		("authorize_admin", cmd_authorize_admin)("deauthorize_admin", cmd_deauthorize_admin)("encrypt_and_push_data", cmd_encrypt_and_push_data)("get_data_and_decrypt", cmd_get_data_and_decrypt)("get_received_devices", cmd_get_received_devices)("update_local_keys", cmd_update_local_keys)("update_public_key", cmd_update_public_key)("help", cmd_help);
}
