...
class EthException : public std::runtime_error {
	public:
		EthException(const char* msg) : std::runtime_error(msg) {}
		EthException(const std::string& msg) : std::runtime_error(msg) {}
};
...
class TransactionException : public EthException {
	public:
		TransactionException(const char* msg) : EthException(msg) {}
		TransactionException(const std::string& msg) : EthException(msg) {}
};
...
class InvalidArgumentException : public EthException {
	public:
		InvalidArgumentException (const char* msg) : EthException(msg) {}
		InvalidArgumentException (const std::string& msg) : EthException(msg) {}
};
...
class DeviceNotAssignedException : public EthException {
	public:
		DeviceNotAssignedException (const char* msg) : EthException(msg) {}
		DeviceNotAssignedException (const std::string& msg) : EthException(msg) {}
};

class ResourceRequestFailedException : public EthException {
	public:
		ResourceRequestFailedException (const char* msg) : EthException(msg) {}
		ResourceRequestFailedException (const std::string& msg) : EthException(msg) {}
};

class ThreadExistsException : public EthException {
	public:
		ThreadExistsException (const char* msg) : EthException(msg) {}
		ThreadExistsException (const std::string& msg) : EthException(msg) {}
};
...
class CryptographicException : public EthException {
	public:
		CryptographicException (const char* msg) : EthException(msg) {}
		CryptographicException (const std::string& msg) : EthException(msg) {}
};
